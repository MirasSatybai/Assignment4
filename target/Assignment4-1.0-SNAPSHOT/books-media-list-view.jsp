                                        ...
                                        <div class="row">                                            
                                            ...
                                            <div class="col-md-3 col-sm-3 pull-right">
                                                <div class="filter-toggle">
                                                    <a href="books-media-gird-view-v1.jsp"><i class="glyphicon glyphicon-th-large"></i></a>
                                                    <a href="books-media-list-view.jsp" class="active"><i class="glyphicon glyphicon-th-list"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="books-list">
                                        <article> 
                                            <div class="single-book-box">                                                
                                                <div class="post-thumbnail">
                                                    ...
                                                    <a href="books-media-detail-v1.jsp"><img alt="Book" src="images/books-media/list-view/book-media-01.jpg" /></a>                                                                 </div>
                                                <div class="post-detail">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <h3 class="entry-title">
                                                                    <a href="books-media-detail-v1.jsp">The Great Gatsby</a>
                                                                </h3>
                                                                <ul>
                                                    ...
                                                    <footer class="entry-footer">
                                                        <a class="btn btn-dark-gray" href="books-media-detail-v1.jsp">Read More</a>
                                                    </footer>
                                                </div>
                                                <div class="clear"></div>
                                            </div>
                                        ...
                                        <article> 
                                            <div class="single-book-box">
                                                <div class="post-thumbnail">
                                                    ...
                                                    <a href="books-media-detail-v1.jsp"><img alt="Book" src="images/books-media/list-view/book-media-02.jpg" /></a>
                                                </div>
                                                <div class="post-detail">
                                                    <div class="books-social-sharing">
                                                        <ul>
                                                    ...
                                                    <header class="entry-header">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <h3 class="entry-title"><a href="books-media-detail-v1.jsp">The Great Gatsby</a></h3>
                                                                <ul>
                                                                    <li><strong>Author:</strong> F. Scott Fitzgerald</li>
                                                                    <li><strong>ISBN:</strong> 9781581573268</li>
                                                                </ul>
                                        ...
                                        <article> 
                                            <div class="single-book-box">
                                                <div class="post-thumbnail">
                                                    ...
                                                    <a href="books-media-detail-v1.jsp"><img alt="Book" src="images/books-media/list-view/book-media-03.jpg" /></a>
                                                </div>
                                                <div class="post-detail">
                                                    <div class="books-social-sharing">
                                                        <ul>
                                        ...
                                        <article> 
                                            <div class="single-book-box">
                                                <div class="post-thumbnail">
                                                    ...
                                                    <a href="books-media-detail-v1.jsp"><img alt="Book" src="images/books-media/list-view/book-media-04.jpg" /></a>
                                                </div>
                                                <div class="post-detail">
                                                    <div class="books-social-sharing">
                                                        <ul>
                                        ...
                                        <article> 
                                            <div class="single-book-box">
                                                <div class="post-thumbnail">
                                                    <div class="book-list-icon red-icon"></div>
                                                    <a href="books-media-detail-v1.jsp"><img alt="Book" src="images/books-media/list-view/book-media-05.jpg" /></a>
                                                </div>
                                                <div class="post-detail">
                                                    <div class="books-social-sharing">
                                                        <ul>
                                        ...
                                        <article> 
                                            <div class="single-book-box">
                                                <div class="post-thumbnail">
                                                    ...
                                                    <a href="books-media-detail-v1.jsp"><img alt="Book" src="images/books-media/list-view/book-media-06.jpg" /></a>
                                                </div>
                                                <div class="post-detail">
                                                    <div class="books-social-sharing">
                                                        <ul>
