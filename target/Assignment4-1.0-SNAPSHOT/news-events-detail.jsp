                                        ...
                                        <div class="related-event text-center">
                                            ...
                                            <div class="owl-carousel-event">
                                                <div class="single-related-event">
                                                    <figure>
                                                        <a href="news-events-detail.jsp"><img src="images/news-event/related-event-01.jpg" alt="Related event"></a>
                                                        <figcaption>
                                                            <header>
                                                                <ul class="news-event-info">
                                                                    <li>
                                                                ...
                                                                <h4><a href=".jsp#">It uses a dictionary of over 200 Latin word</a></h4>
                                                            </header>
                                                ...
                                                <div class="single-related-event">
                                                    <figure>
                                                        <a href="news-events-detail.jsp"><img src="images/news-event/related-event-02.jpg" alt="Related event"></a>
                                                        <figcaption>
                                                            <header>
                                                                <ul class="news-event-info">
                                                                    <li>
                                                ...
                                                <div class="single-related-event">
                                                    <figure>
                                                        <a href="news-events-detail.jsp"><img src="images/news-event/related-event-03.jpg" alt="Related event"></a>
                                                        <figcaption>
                                                            <header>
                                                                <ul class="news-event-info">
                                                                    <li>
