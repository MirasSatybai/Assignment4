                                        ...
                                        <div class="row">                                            
                                            ...
                                            <div class="col-md-3 col-sm-3 pull-right">
                                                <div class="filter-toggle">
                                                    <a href="books-media-gird-view-v1.jsp" class="active"><i class="glyphicon glyphicon-th-large"></i></a>
                                                ...
                                                <div class="single-book-box">
                                                    <div class="post-detail">
                                                        ...
                                                        <footer class="entry-footer">
                                                            <a class="btn btn-primary" href="books-media-detail-v1.jsp">Read More</a>
                                                        </footer>
                                                    </div>
                                                </div>                                       
                                            </li>
