                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                <a href="signin.jsp"><i class="fa fa-lock"></i>Login / Register</a>
                                                <span>|</span>
                                ...
                                <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        <li class="dropdown active">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="index-2.jsp">Home</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="index-2.jsp">Home V1</a></li>
                                                <li><a href="home-v2.jsp">Home V2</a></li>
                                                <li><a href="home-v3.jsp">Home V3</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="books-media-list-view.jsp">Books &amp; Media</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="books-media-list-view.jsp">Books &amp; Media List View</a></li>
                                                <li><a href="books-media-gird-view-v1.jsp">Books &amp; Media Grid View V1</a></li>
                                                <li><a href="books-media-gird-view-v2.jsp">Books &amp; Media Grid View V2</a></li>
                                                <li><a href="books-media-detail-v1.jsp">Books &amp; Media Detail V1</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="signin.jsp">Signin/Register</a></li>
                        ...
                        <div class="mobile-menu hidden-lg hidden-md">
                            ...
                            <div id="mobile-menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="books-media-list-view.jsp">Books &amp; Media</a>
                                        <ul>
                                            <li><a href="books-media-list-view.jsp">Books &amp; Media List View</a></li>
                                            <li><a href="books-media-gird-view-v1.jsp">Books &amp; Media Grid View V1</a></li>
                                            <li><a href="books-media-gird-view-v2.jsp">Books &amp; Media Grid View V2</a></li>
                                    ...
                                    <li>
                                        <a href="news-events-list-view.jsp">News &amp; Events</a>
                                        <ul>
                                            <li><a href="news-events-list-view.jsp">News &amp; Events List View</a></li>
                                            <li><a href="news-events-detail.jsp">News &amp; Events Detail</a></li>
                                        </ul>
                                ...
                                <div class="row">                                            
                                    ...
                                    <div class="col-md-2 col-sm-12 pull-right">
                                        <div class="filter-toggle">
                                            <a href="books-media-gird-view-v2.jsp" class="active"><i class="glyphicon glyphicon-th-large"></i></a>
                                            <a href="books-media-list-view.jsp"><i class="glyphicon glyphicon-th-list"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="booksmedia-fullwidth">
                                <ul>
                                    <li>
                                        ...
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-01.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                    ...
                                    <li>
                                        ...
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-02.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                    ...
                                    <li>
                                        ...
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-03.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                    ...
                                    <li>
                                        <div class="book-list-icon yellow-icon"></div>
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-04.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                    ...
                                    <li>
                                        <div class="book-list-icon blue-icon"></div>
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-05.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                    ...
                                    <li>
                                        ...
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-06.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                    ...
                                    <li>
                                        <div class="book-list-icon green-icon"></div>
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-07.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                                    ...
                                    <li>
                                        <div class="book-list-icon red-icon"></div>
                                        <figure>
                                            <a href="books-media-detail-v2.jsp"><img src="images/books-media/layout-3/books-media-layout3-09.jpg" alt="Book"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.jsp">The Great Gatsby</a></h4>
                                                    <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
